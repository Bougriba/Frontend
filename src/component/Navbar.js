                        ...
                        >
                          {
                                ...
                                <Typography textAlign="center"><Link style={{ textDecoration: "none", color: palette.primary.main }} to="/admin/dashboard">Admin Dashboard</Link></Typography>
                                    ...
                                    <>
                                            <MenuItem onClick={handleCloseUserMenu}>
                                <Typography textAlign="center"><Link style={{ textDecoration: "none", color: palette.primary.main }} to="/job_seeker/dashboard">job_seeker Dashboard</Link></Typography>
                                        </MenuItem>
                                        </>
                                        : userInfo && userInfo.role === "recruiter" ?
                                        <>
                                           <MenuItem onClick={handleCloseUserMenu}>
                                <Typography textAlign="center"><Link style={{ textDecoration: "none", color: palette.primary.main }} to="/recruiter/dashboard">Recruiter Dashboard</Link></Typography>
                                        </MenuItem>
                                            </>
                                            : null
    ...
    <MenuItem onClick={handleCloseUserMenu}>
        <Typography textAlign="center">
            <Link style={{ textDecoration: "none", color: palette.primary.main }} to="/login">Log In</Link>
                                   ...
                                   <MenuItem onClick={handleCloseUserMenu}>
                                   <Typography textAlign="center">
                                       <Link style={{ textDecoration: "none", color: palette.primary.main }} to="/register">Register</Link>
                                   </Typography>
                                    </MenuItem>
                                    </>
) : (
